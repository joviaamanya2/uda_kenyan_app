...
class _LanguageSelectionScreenState extends State<LanguageSelectionScreen>
  ...
  void initState() {
    ...
    // Reflect the currently active language.
    _selectedLanguage = AppSettings.instance.languageCode == 'sw'
        ? 'Kiswahili'
        : 'English';
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              // Subtitle
                              Text(
                                context.l10n('language_subtitle'),
                                textAlign: TextAlign.center,
                                style: TextStyle(
                          ...
                          child: SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: _isLoading
                                  ...
                                  : Text(
                                      '${context.l10n('continue')} · $_selectedLanguage',
                                      style: const TextStyle(
                                        fontSize: 14,
